							...
							<form class="row g-3 needs-validation" action="PayrollServlet"
								...
								<div class="row">
									<div class="col-md-6 position-relative">
										<label for="validationTooltip01" class="form-label">First
											...
											id="payrollName" placeholder="John" required
											title="Enter Name">
								...
								<div class="col-md-6 d-none position-relative">
									...
									<div class="input-group has-validation">
										<input type="email" class="form-control" id="payrollEmail02"placeholder="xxx@gmail.com"
											name="email">
								...
								<div class="row">
									<div class="col-md-6 position-relative">
										...
										<input type="text" class="form-control" required name="salary"
											title="Enter salary number" id="payrollSalary" placeholder="00.00" pattern="^\d+$"
											maxlength="10">
									...
									<div class="col-md-6 position-relative mx-auto">
										...
										<input type="text" class="form-control" name="bonus" required
											title="Enter bonus" id="payrollBonus" placeholder="00.00" pattern="^\d+$"
											maxlength="12">
						...
						<div class="modal-body">
							<form class="row g-3 needs-validation" action="PayrollServlet"
								...
								<div class="col-md-6 position-relative">
									<label for="validationTooltip01" class="form-label">First
										name</label> <input type="text" name="fname" class="form-control"
										placeholder="John" required title="Enter Name">
								...
								<div class="col-md-6 position-relative">
									...
									<div class="input-group has-validation">
										<input type="email" class="form-control" name="email" required
											title="Enter Email" placeholder="xxx@gmail.com">
								...
								<div class="col-md-6 position-relative">
									...
									<input type="text" class="form-control"
										id="validationTooltip05" placeholder="00.00"required name="salary"
								...
								<div class="col-md-6 position-relative">
									...
									<input type="text" class="form-control" name="bonus"
										id="validationTooltip05" placeholder="00.00" required title="Enter Bonus"
